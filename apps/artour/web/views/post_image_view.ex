defmodule Artour.PostImageView do
  ...
  def display_name(post_image) do
    "Post " <>
      Integer.to_string(post_image.post_id) <> " Image " <> Integer.to_string(post_image.image_id)
  end

  def show_path(post_image) do
    ~p"/admin/post_images/#{post_image}"
  end

  def edit_path(post_image) do
    ~p"/admin/post_images/#{post_image}/edit"
  end
