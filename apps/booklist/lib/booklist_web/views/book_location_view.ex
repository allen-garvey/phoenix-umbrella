defmodule BooklistWeb.BookLocationView do
  ...
  def to_s(book_location) do
    BooklistWeb.BookView.to_s(book_location.book) <>
      "—" <> BooklistWeb.LocationView.to_s(book_location.location)
  end

  def show_path(book_location) do
  ...
  def to_s_location(book_location) do
    to_s_with_call_number(
      BooklistWeb.LocationView.to_s_full(book_location.location),
      book_location.call_number
    )
  end
  ...
  def super_search_direct_link(library_key, search_query, link_text) do
    link(link_text,
      to: Common.SuperSearch.direct_search_url(library_key, search_query),
      class: "super_search_link",
      data_role: "qr-call-number"
    )
  end
end
